...
defmodule Day09.TileFloorTest do
  ...
  describe "build and check" do
    ...
    test "non inside borders tiles" do
      ...
      #assert TileFloor.is_inside_borders(@tile_floor, {2, 6}) == false
      #assert TileFloor.is_inside_borders(@tile_floor, {11, 8}) == false
    end
    ...
    test "tiles on borders are not inside the borders" do
      ...
      assert TileFloor.is_inside_borders(@tile_floor, {11, 2}) == true
      assert TileFloor.is_inside_borders(@tile_floor, {11, 3}) == true
      assert TileFloor.is_inside_borders(@tile_floor, {11, 4}) == true
      ...
      assert TileFloor.is_inside_borders(@tile_floor, {2, 4}) == true
      assert TileFloor.is_inside_borders(@tile_floor, {7, 2}) == true
